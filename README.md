# Alipay Clean Room Actor

Clean-room API-compatible implementation of the alipay regional super app/infrastructure, backed by Datomic and Py Kotodama WASM.
...
Relocated 2026-07-04 from `etzhayyim/root/20-actors/alipay-compat` to
`kotoba-lang/com-alipay` per the org-taxonomy library-placement rule (any
